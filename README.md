...
Backend-сервис для автоматической подготовки штрих-кодов Ozon FBS к печати на обычном принтере.

Проект был создан для продавцов маркетплейсов (Ozon / FBS), которые получают штрих-коды в формате PDF, но печатают их на обычном A4-принтере.
